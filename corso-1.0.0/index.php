...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="feedback/aaaa.php">Feedback</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="feedback/view_feedback.php">View Feedback</a>
                </li>
            </ul>
    ...
    <li style="margin-bottom: 10px; color:black;"><b>TK Vamshi Krishna - 21MIC7023</b></li>
</ul>
